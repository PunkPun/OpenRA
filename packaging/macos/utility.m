...
int main(int argc, char **argv)
{
	...
	if (useMono)
	{
		...
		{
			NSLog(@"Utility requires Mono %@ or later. Please install Mono and try again.", SYSTEM_MONO_MIN_VERSION);
			return 1;
		}
	}
	...
	if (useMono)
		return launch_mono(argc, argv, modId);
	else
		return launch_dotnet(argc, argv, modId, isArmArchitecture);
}
