...
namespace OpenRA
{
	...
	public class Manifest : IDisposable
	{
		...
		public readonly string[]
			...
			Weapons, Voices, Notifications, Music, Translations, ServerTranslations, TileSets,
		...
		readonly string[] reservedModuleNames =
		{
			...
			"Voices", "Notifications", "Music", "Translations", "ServerTranslations", "TileSets", "ChromeMetrics", "Missions", "Hotkeys",
		...
		public Manifest(string modId, IReadOnlyPackage package)
		{
			...
			ServerTranslations = YamlList(yaml, "ServerTranslations");
