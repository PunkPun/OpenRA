...
{
	public class RefineryInfo : TraitInfo, Requires<WithSpriteBodyInfo>
	{
	...
	public class Refinery : IAcceptResources, INotifyCreated, ITick, INotifyOwnerChanged
	{
		...
		public virtual Activity DockSequence(Actor clientActor, DockClientManager client, Actor hostActor, DockHost host)
		{
			return new SpriteHarvesterDockSequence(clientActor, client, hostActor, host);
		}
